package com.suninfo.emm.coolweather.service;
...
import com.suninfo.emm.coolweather.receiver.AutoUpdateReceiver;
...
//		int anHour = 8 * 60 * 60 * 1000; // 这是8小时的毫秒数
    ...
    private void updateWeather() {
        ...
        HttpUtil.sendHttpRequest(null, address, new HttpCallbackListener() {
            @Override
